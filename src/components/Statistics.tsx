...
export default function Statistics({ dict }: StatisticsProps) {
  return (
    <section id="statistics" className="flex w-full flex-col pt-17.5 pb-50 md:pb-66.75">
      <div className="text-section-title text-portfolio-black mb-17.5 w-full text-center font-medium">
        {dict.title}
      </div>
      ...
      <div className="grid grid-cols-1 gap-x-20 gap-y-12 md:grid-cols-3 md:gap-y-16">
        <div className="flex flex-col">
          ...
          <div className="border-portfolio-black mt-4 border-t-[3px] pt-4 md:mt-6 md:pt-6">
            <p className="text-stat-description text-portfolio-black text-left leading-snug font-medium md:text-justify md:leading-13">
      ...
      <div className="mt-20 flex w-full flex-col md:mt-27">
        <h3 className="text-highlights-title text-portfolio-small font-medium">
          {dict.highlights.title}
        </h3>

        <div className="mt-11 grid grid-cols-1 gap-x-20 gap-y-12 md:grid-cols-3">
          <div className="flex flex-col">
            <h4 className="text-highlight-heading text-portfolio-black mb-3 font-bold md:mb-4">
              {dict.highlights.item1.title}
            </h4>
            <p className="text-highlight-body text-portfolio-black text-left font-medium md:text-justify">
