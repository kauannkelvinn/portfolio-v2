...
export default function About({ dict }: AboutProps) {
  ...
  return (
    <section
      id="about"
      className="bg-portfolio-white border-portfolio-black pb:16 relative flex w-full flex-col border-b-2 py-12 md:py-12.5 md:pb-26"
    >
      <div className="mb-12 w-full text-center md:mb-23">
      ...
      <div className="grid grid-cols-1 gap-x-20 gap-y-10 md:grid-cols-2 md:gap-y-0">
        <div className="flex w-full flex-col leading-snug md:w-auto md:max-w-157 md:leading-13">
          <p className="reveal-lines text-section-body text-portfolio-black text-left font-medium md:text-justify">
            {dict.paragraph1}
          </p>
        </div>
